...
_PROJECT_HOMEPAGE_URL = "https://roam-code.com/"
...
def _render_attribution_footer() -> str:
    """Return the opt-out attribution footer for generated AGENTS.md files."""
