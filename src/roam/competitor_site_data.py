...
MAP_METADATA: dict[str, dict[str, object]] = {
    "roam-code": {
        ...
        "note": "Graph algorithms (PageRank, SCC, Louvain, Fiedler) on tree-sitter ASTs fused with git history in SQLite. 123 MCP tools, 172 CLI commands. 19 Python idiom detectors (v12.7+).",
        "version_evaluated": "12.17",
